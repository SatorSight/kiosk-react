...
import IssuesTheme from './IssuesTheme';
import NextArticle from './NextArticle';
// import TestOn from './test';
...
ReactDOM.render(<MainTabs />, document.querySelector('#tabs'));
ReactDOM.render(<IssuesTheme />, document.querySelector('#theme'));
ReactDOM.render(<NextArticle />, document.querySelector('#next'));
// ReactDOM.render(<TestOn />, document.querySelector('#test'));